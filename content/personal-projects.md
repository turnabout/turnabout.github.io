...
I joined forces with two talented data scientists who founded the platform and create content for it. I’m responsible for the development and maintenance of the platform, as well as the creation of new features.

Over the years, I worked on a variety of features, including:

- The entirety of the current website stack
    - Next.js/TypeScript
    - Go backend for handling user authentication and storing user data
- A newsletter system, implemented in Go and running on AWS Lambda. Responsible for sending out the correct question emails to the correct users
